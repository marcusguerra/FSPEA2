 ...
 * </ol>
 */
public class ISPEA3 extends AbstractEvolutionaryAlgorithm {
	 ...
	 */
	public ISPEA3(Problem problem, int initialPopulationSize, Initialization initialization,
	...
	protected void iterate() {
		...
		int populationSize = population.size();
			...
			// maintaining a pool of candidate parents.
				...
				// run NSGA-II using selection without replacement; this version allows
